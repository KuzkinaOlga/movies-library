 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var zt;zt="",Ct(new G("platform-logger",(t=>new Et(t)),"PRIVATE")),Ct(new G("heartbeat",(t=>new Bt(t)),"PRIVATE")),Dt("@firebase/app","0.7.26",zt),Dt("@firebase/app","0.7.26","esm2017"),Dt("fire-js","");
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ls{static fromPath(t){return new Ls(Ns.fromString(t))}static fromName(t){return new Ls(Ns.fromString(t).popFirst(5))}static empty(){return new Ls(Ns.emptyPath())}get collectionGroup(){return this.path.popLast().lastSegment()}hasCollectionId(t){return this.path.length>=2&&this.path.get(this.path.length-2)===t}getCollectionGroup(){return this.path.get(this.path.length-2)}getCollectionPath(){return this.path.popLast()}isEqual(t){return null!==t&&0===Ns.comparator(this.path,t.path)}toString(){return this.path.toString()}static comparator(t,e){return Ns.comparator(t.path,e.path)}static isDocumentKey(t){return t.length%2==0}static fromSegments(t){return new Ls(new Ns(t.slice()))}constructor(t){this.path=t}}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ds{constructor(t,e,n,i){this.indexId=t,this.collectionGroup=e,this.fields=n,this.indexState=i}}Ds.UNKNOWN_ID=-1;function Rs(t,e){const n=t.toTimestamp().seconds,i=t.toTimestamp().nanoseconds+1,r=Ss.fromTimestamp(1e9===i?new xs(n+1,0):new xs(n,i));return new Ms(r,Ls.empty(),e)}function Ps(t){return new Ms(t.readTime,t.key,-1)}class Ms{static min(){return new Ms(Ss.min(),Ls.empty(),-1)}static max(){return new Ms(Ss.max(),Ls.empty(),-1)}constructor(t,e,n){this.readTime=t,this.documentKey=e,this.largestBatchId=n}}function Us(t,e){let n=t.readTime.compareTo(e.readTime);return 0!==n?n:(n=Ls.comparator(t.documentKey,e.documentKey),0!==n?n:Ts(t.largestBatchId,e.largestBatchId))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xa=new Ks(Ls.comparator);function Ja(){return Xa}const Ya=new Ks(Ls.comparator);function Za(...t){let e=Ya;for(const n of t)e=e.insert(n.key,n);return e}function tc(t){let e=Ya;return t.forEach(((t,n)=>e=e.insert(t,n.overlayedDocument))),e}function ec(){return ic()}function nc(){return ic()}function ic(){return new Qa((t=>t.toString()),((t,e)=>t.isEqual(e)))}const rc=new Ks(Ls.comparator),sc=new Xs(Ls.comparator);function oc(...t){let e=sc;for(const n of t)e=e.add(n);return e}const ac=new Xs(Ts);function cc(){return ac}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hl{isEmpty(){return this.Zn.isEmpty()}addReference(t,e){const n=new dl(t,e);this.Zn=this.Zn.add(n),this.es=this.es.add(n)}ss(t,e){t.forEach((t=>this.addReference(t,e)))}removeReference(t,e){this.rs(new dl(t,e))}os(t,e){t.forEach((t=>this.removeReference(t,e)))}us(t){const e=new Ls(new Ns([])),n=new dl(e,t),i=new dl(e,t+1),r=[];return this.es.forEachInRange([n,i],(t=>{this.rs(t),r.push(t.key)})),r}cs(){this.Zn.forEach((t=>this.rs(t)))}rs(t){this.Zn=this.Zn.delete(t),this.es=this.es.delete(t)}hs(t){const e=new Ls(new Ns([])),n=new dl(e,t),i=new dl(e,t+1);let r=oc();return this.es.forEachInRange([n,i],(t=>{r=r.add(t.key)})),r}containsKey(t){const e=new dl(t,0),n=this.Zn.firstAfterOrEqual(e);return null!==n&&t.isEqual(n.key)}constructor(){this.Zn=new Xs(dl.ts),this.es=new Xs(dl.ns)}}class dl{static ts(t,e){return Ls.comparator(t.key,e.key)||Ts(t.ls,e.ls)}static ns(t,e){return Ts(t.ls,e.ls)||Ls.comparator(t.key,e.key)}constructor(t,e){this.key=t,this.ls=e}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pl{setIndexManager(t){this.indexManager=t}addEntry(t,e){const n=e.key,i=this.docs.get(n),r=i?i.size:0,s=this.ps(e);return this.docs=this.docs.insert(n,{document:e.mutableCopy(),size:s}),this.size+=s-r,this.indexManager.addToCollectionParentIndex(t,n.path.popLast())}removeEntry(t){const e=this.docs.get(t);e&&(this.docs=this.docs.remove(t),this.size-=e.size)}getEntry(t,e){const n=this.docs.get(e);return js.resolve(n?n.document.mutableCopy():Lo.newInvalidDocument(e))}getEntries(t,e){let n=Ja();return e.forEach((t=>{const e=this.docs.get(t);n=n.insert(t,e?e.document.mutableCopy():Lo.newInvalidDocument(t))})),js.resolve(n)}getAllFromCollection(t,e,n){let i=Ja();const r=new Ls(e.child("")),s=this.docs.getIteratorFrom(r);for(;s.hasNext();){const{key:t,value:{document:r}}=s.getNext();if(!e.isPrefixOf(t.path))break;t.path.length>e.length+1||Us(Ps(r),n)<=0||(i=i.insert(r.key,r.mutableCopy()))}return js.resolve(i)}getAllFromCollectionGroup(t,e,n,i){ls()}Is(t,e){return js.forEach(this.docs,(t=>e(t)))}newChangeBuffer(t){return new ml(this)}getSize(t){return js.resolve(this.size)}constructor(t){this.ps=t,this.docs=new Ks(Ls.comparator),this.size=0}}class ml extends ol{applyChanges(t){const e=[];return this.changes.forEach(((n,i)=>{i.isValidDocument()?e.push(this.zn.addEntry(t,i)):this.zn.removeEntry(n)})),js.waitFor(e)}getFromCache(t,e){return this.zn.getEntry(t,e)}getAllFromCache(t,e){return this.zn.getEntries(t,e)}constructor(t){super(),this.zn=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Od(t,...e){throw Pd(t,...e)}function Ld(t,...e){return Pd(t,...e)}function Dd(t,e,n){const i=Object.assign(Object.assign({},Sd()),{[e]:n});return new M("auth","Firebase",i).create(e,{appName:t.name})}function Rd(t,e,n){if(!(e instanceof n))throw n.name!==e.constructor.name&&Od(t,"argument-error"),Dd(t,"argument-error",`Type of ${e.constructor.name} does not match expected instance.Did you pass a reference from a different Auth SDK?`)}function Pd(t,...e){if("string"!=typeof t){const n=e[0],i=[...e.slice(1)];return i[0]&&(i[0].appName=t.name),t._errorFactory.create(n,...i)}return Cd.create(t,...e)}function Md(t,e,...n){if(!t)throw Pd(e,...n)}function Ud(t){const e="INTERNAL ASSERTION FAILED: "+t;throw Ad(e),new Error(e)}function Bd(t,e){t||Ud(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class $d{get(){return"undefined"!=typeof navigator&&navigator&&"onLine"in navigator&&"boolean"==typeof navigator.onLine&&(zd()||O()||"connection"in navigator)&&!navigator.onLine?Math.min(5e3,this.shortDelay):this.isMobile?this.longDelay:this.shortDelay}constructor(t,e){this.shortDelay=t,this.longDelay=e,Bd(e>t,"Short delay should be less than long delay!"),this.isMobile=A()||L()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Lf{toJSON(){return Ud("not implemented")}_getIdTokenResponse(t){return Ud("not implemented")}_linkToIdToken(t,e){return Ud("not implemented")}_getReauthenticationResolver(t){return Ud("not implemented")}constructor(t,e){this.providerId=t,this.signInMethod=e}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Df(t,e){return Xd(t,"POST","/v1/accounts:update",e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Rf extends Lf{static _fromEmailAndPassword(t,e){return new Rf(t,e,"password")}static _fromEmailAndCode(t,e,n=null){return new Rf(t,e,"emailLink",n)}toJSON(){return{email:this._email,password:this._password,signInMethod:this.signInMethod,tenantId:this._tenantId}}static fromJSON(t){const e="string"==typeof t?JSON.parse(t):t;if((null==e?void 0:e.email)&&(null==e?void 0:e.password)){if("password"===e.signInMethod)return this._fromEmailAndPassword(e.email,e.password);if("emailLink"===e.signInMethod)return this._fromEmailAndCode(e.email,e.password,e.tenantId)}return null}async _getIdTokenResponse(t){switch(this.signInMethod){case"password":
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var r,s;i.setAttribute("src",t),i.onload=e,i.onerror=t=>{const e=Ld("internal-error");e.customData=t,n(e)},i.type="text/javascript",i.charset="UTF-8",(null!==(s=null===(r=document.getElementsByTagName("head"))||void 0===r?void 0:r[0])&&void 0!==s?s:document).appendChild(i)}))}function wp(t){return`__${t}${Math.floor(1e6*Math.random())}`}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cp=new $d(2e3,1e4);async function Np(t,e,n){const i=Af(t);Rd(t,e,jf);const r=Ep(i,n);return new Ap(i,"signInViaPopup",e,r).executeNotNull()}class Ap extends Sp{async executeNotNull(){const t=await this.execute();return Md(t,this.auth,"internal-error"),t}async onExecution(){Bd(1===this.filter.length,"Popup operations only handle one event");const t=ap();this.authWindow=await this.resolver._openPopup(this.auth,this.provider,this.filter[0],t),this.authWindow.associatedEvent=t,this.resolver._originValidation(this.auth).catch((t=>{this.reject(t)})),this.resolver._isIframeWebStorageSupported(this.auth,(t=>{t||this.reject(Ld(this.auth,"web-storage-unsupported"))})),this.pollUserCancellation()}get eventId(){var t;return(null===(t=this.authWindow)||void 0===t?void 0:t.associatedEvent)||null}cancel(){this.reject(Ld(this.auth,"cancelled-popup-request"))}cleanUp(){this.authWindow&&this.authWindow.close(),this.pollId&&window.clearTimeout(this.pollId),this.authWindow=null,this.pollId=null,Ap.currentPopupAction=null}pollUserCancellation(){const t=()=>{var e,n;(null===(n=null===(e=this.authWindow)||void 0===e?void 0:e.window)||void 0===n?void 0:n.closed)?this.pollId=window.setTimeout((()=>{this.pollId=null,this.reject(Ld(this.auth,"popup-closed-by-user"))}),2e3):this.pollId=window.setTimeout(t,Cp.get())};t()}constructor(t,e,n,i,r){super(t,e,i,r),this.provider=n,this.authWindow=null,this.pollId=null,Ap.currentPopupAction&&Ap.currentPopupAction.cancel(),Ap.currentPopupAction=this}}Ap.currentPopupAction=null;
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const Op=new Map;class Lp extends Sp{async execute(){let t=Op.get(this.auth._key());if(!t){try{const e=await async function(t,e){const n=Pp(e),i=Rp(t);if(!await i._isAvailable())return!1;const r="true"===await i._get(n);return await i._remove(n),r}(this.resolver,this.auth)?await super.execute():null;t=()=>Promise.resolve(e)}catch(e){t=()=>Promise.reject(e)}Op.set(this.auth._key(),t)}return this.bypassAuthState||Op.set(this.auth._key(),(()=>Promise.resolve(null))),t()}async onAuthEvent(t){if("signInViaRedirect"===t.type)return super.onAuthEvent(t);if("unknown"!==t.type){if(t.eventId){const e=await this.auth._redirectUserForId(t.eventId);if(e)return this.user=e,super.onAuthEvent(t);this.resolve(null)}}else this.resolve(null)}async onExecution(){}cleanUp(){}constructor(t,e,n=!1){super(t,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],e,void 0,n),this.eventId=null}}function Dp(t,e){Op.set(t._key(),e)}function Rp(t){return Vd(t._redirectPersistence)}function Pp(t){return mf("pendingRedirect",t.config.apiKey,t.name)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $p=new $d(3e4,6e4);function Hp(){const t=lp().___jsl;if(null==t?void 0:t.H)for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let e=0;e<t.CP.length;e++)t.CP[e]=null}let Wp=null;function Kp(t){return Wp=Wp||function(t){return new Promise(((e,n)=>{var i,r,s;function o(){Hp(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Hp(),n(Ld(t,"network-request-failed"))},timeout:$p.get()})}if(null===(r=null===(i=lp().gapi)||void 0===i?void 0:i.iframes)||void 0===r?void 0:r.Iframe)e(gapi.iframes.getContext());else{if(!(null===(s=lp().gapi)||void 0===s?void 0:s.load)){const e=wp("iframefcb");return lp()[e]=()=>{gapi.load?o():n(Ld(t,"network-request-failed"))},vp(`https://apis.google.com/js/api.js?onload=${e}`).catch((t=>n(t)))}o()}})).catch((t=>{throw Wp=null,t}))}(t),Wp}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(t)}?${j(a).slice(1)}`}const nm=class{async _openPopup(t,e,n,i){var r;Bd(null===(r=this.eventManagers[t._key()])||void 0===r?void 0:r.manager,"_initialize() not called before _openPopup()");return tm(t,em(t,e,n,jd(),i),ap())}async _openRedirect(t,e,n,i){var r;return await this._originValidation(t),r=em(t,e,n,jd(),i),lp().location.href=r,new Promise((()=>{}))}_initialize(t){const e=t._key();if(this.eventManagers[e]){const{manager:t,promise:n}=this.eventManagers[e];return t?Promise.resolve(t):(Bd(n,"If manager is not set, promise should be"),n)}const n=this.initAndGetManager(t);return this.eventManagers[e]={promise:n},n.catch((()=>{delete this.eventManagers[e]})),n}async initAndGetManager(t){const e=await async function(t){const e=await Kp(t),n=lp().gapi;return Md(n,t,"internal-error"),e.open({where:document.body,url:Jp(t),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:Qp,dontclear:!0},(e=>new Promise((async(n,i)=>{await e.restyle({setHideOnLeave:!1});const r=Ld(t,"network-request-failed"),s=lp().setTimeout((()=>{i(r)}),Gp.get());function o(){lp().clearTimeout(s),n(e)}e.ping(o).then(o,(()=>{i(r)}))}))))}(t),n=new Up(t);return e.register("authEvent",(e=>{Md(null==e?void 0:e.authEvent,t,"invalid-auth-event");return{status:n.onEvent(e.authEvent)?"ACK":"ERROR"}}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[t._key()]={manager:n},this.iframes[t._key()]=e,n}_isIframeWebStorageSupported(t,e){this.iframes[t._key()].send("webStorageSupport",{type:"webStorageSupport"},(n=>{var i;const r=null===(i=null==n?void 0:n[0])||void 0===i?void 0:i.webStorageSupport;void 0!==r&&e(!!r),Od(t,"internal-error")}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(t){const e=t._key();return this.originValidationPromises[e]||(this.originValidationPromises[e]=zp(t)),this.originValidationPromises[e]}get _shouldInitProactively(){return xf()||wf()||kf()}constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=sp,this._completeRedirectFn=Mp,this._overrideRedirectResult=Dp}};var im;
/**
 * @license
 * Copyright 2020 Google LLC
 *
