 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function za(t,e){if(t.dt){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Us(e)?"-0":e}}function Va(t){return{integerValue:""+t}}function ja(t,e){return Fs(e)?Va(e):za(t,e)}
/**
 * @license
 * Copyright 2018 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wa{constructor(){this._=void 0}}function qa(t,e,n){return t instanceof Ka?Xa(t,e):t instanceof Ga?Qa(t,e):n}function Ha(t,e){var n;return t instanceof Ya?Gs(n=e)||function(t){return!!t&&"doubleValue"in t}(n)?e:{integerValue:0}:null}class $a extends Wa{}class Ka extends Wa{constructor(t){super(),this.elements=t}}function Xa(t,e){const n=Za(e);for(const e of t.elements)n.some((t=>js(t,e)))||n.push(e);return{arrayValue:{values:n}}}class Ga extends Wa{constructor(t){super(),this.elements=t}}function Qa(t,e){let n=Za(e);for(const e of t.elements)n=n.filter((t=>!js(t,e)));return{arrayValue:{values:n}}}class Ya extends Wa{constructor(t,e){super(),this.wt=t,this._t=e}}function Ja(t){return As(t.integerValue||t.doubleValue)}function Za(t){return Qs(t)&&t.arrayValue.values?t.arrayValue.values.slice():[]}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jl{start(){return Promise.resolve()}shutdown(){return this.vs=!1,Promise.resolve()}get started(){return this.vs}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(t){return this.indexManager}getDocumentOverlayCache(t){let e=this.overlays[t.toKey()];return e||(e=new Ml,this.overlays[t.toKey()]=e),e}getMutationQueue(t,e){let n=this.bs[t.toKey()];return n||(n=new Ul(e,this.referenceDelegate),this.bs[t.toKey()]=n),n}getTargetCache(){return this.Vs}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Ds}runTransaction(t,e,n){Ro("MemoryPersistence","Starting transaction:",t);const i=new Wl(this.Ps.next());return this.referenceDelegate.Cs(),n(i).next((t=>this.referenceDelegate.xs(i).next((()=>t)))).toPromise().then((t=>(i.raiseOnCommittedEvent(),t)))}Ns(t,e){return ps.or(Object.values(this.bs).map((n=>()=>n.containsKey(t,e))))}constructor(t,e){this.bs={},this.overlays={},this.Ps=new gs(0),this.vs=!1,this.vs=!0,this.referenceDelegate=t(this),this.Vs=new Vl(this),this.indexManager=new Nl,this.remoteDocumentCache=function(t){return new Fl(t)}((t=>this.referenceDelegate.Ss(t))),this.wt=new El(e),this.Ds=new Ol(this.wt)}}class Wl extends fs{constructor(t){super(),this.currentSequenceNumber=t}}class ql{static Ms(t){return new ql(t)}get Fs(){if(this.Os)return this.Os;throw Po()}addReference(t,e,n){return this.ks.addReference(n,e),this.Fs.delete(n.toString()),ps.resolve()}removeReference(t,e,n){return this.ks.removeReference(n,e),this.Fs.add(n.toString()),ps.resolve()}markPotentiallyOrphaned(t,e){return this.Fs.add(e.toString()),ps.resolve()}removeTarget(t,e){this.ks.us(e.targetId).forEach((t=>this.Fs.add(t.toString())));const n=this.persistence.getTargetCache();return n.getMatchingKeysForTargetId(t,e.targetId).next((t=>{t.forEach((t=>this.Fs.add(t.toString())))})).next((()=>n.removeTargetData(t,e)))}Cs(){this.Os=new Set}xs(t){const e=this.persistence.getRemoteDocumentCache().newChangeBuffer();return ps.forEach(this.Fs,(n=>{const i=os.fromPath(n);return this.$s(t,i).next((t=>{t||e.removeEntry(i,ts.min())}))})).next((()=>(this.Os=null,e.apply(t))))}updateLimboDocument(t,e){return this.$s(t,e).next((t=>{t?this.Fs.delete(e.toString()):this.Fs.add(e.toString())}))}Ss(t){return 0}$s(t,e){return ps.or([()=>ps.resolve(this.ks.containsKey(e)),()=>this.persistence.getTargetCache().containsKey(t,e),()=>this.persistence.Ns(t,e)])}constructor(t){this.persistence=t,this.ks=new Pl,this.Os=null}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vd(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Hd(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(jd(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Kd(e))return"Blackberry";if(Xd(e))return"Webos";if(Wd(e))return"Safari";if((e.includes("chrome/")||qd(e))&&!e.includes("edge/"))return"Chrome";if($d(e))return"Android";{const e=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=t.match(e);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function jd(t=et()){return/firefox\//i.test(t)}function Wd(t=et()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function qd(t=et()){return/crios\//i.test(t)}function Hd(t=et()){return/iemobile/i.test(t)}function $d(t=et()){return/android/i.test(t)}function Kd(t=et()){return/blackberry/i.test(t)}function Xd(t=et()){return/webos/i.test(t)}function Gd(t=et()){return/iphone|ipad|ipod/i.test(t)}function Qd(t=et()){return Gd(t)||$d(t)||Xd(t)||Kd(t)||/windows phone/i.test(t)||Hd(t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Yd(t,e=[]){let n;switch(t){case"Browser":n=Vd(et());break;case"Worker":n=`${Vd(et())}-${t}`;break;default:n=t}return`${n}/JsCore/9.8.3/${e.length?e.join(","):"FirebaseCore-web"}`}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jp(t){return new Promise(((e,n)=>{const i=document.createElement("script");
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pm=new md(3e4,6e4);function mm(){const t=Dp().___jsl;if(null==t?void 0:t.H)for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let e=0;e<t.CP.length;e++)t.CP[e]=null}let gm=null;function ym(t){return gm=gm||function(t){return new Promise(((e,n)=>{var i,r,o;function s(){mm(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{mm(),n(id(t,"network-request-failed"))},timeout:pm.get()})}if(null===(r=null===(i=Dp().gapi)||void 0===i?void 0:i.iframes)||void 0===r?void 0:r.Iframe)e(gapi.iframes.getContext());else{if(!(null===(o=Dp().gapi)||void 0===o?void 0:o.load)){const e=Wp("iframefcb");return Dp()[e]=()=>{gapi.load?s():n(id(t,"network-request-failed"))},jp(`https://apis.google.com/js/api.js?onload=${e}`).catch((t=>n(t)))}s()}})).catch((t=>{throw gm=null,t}))}(t),gm}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
